...
import com.app.entity.PagingInfo;
...
public class QnaController {
    ...
    public String updateQna(@ModelAttribute("user") User user, Qna qna, 
        ...
        User currentUserInfo = userService.findUserByUsername(principal.getName()); // 현재 로그인한 사용자의 정보를 데이터베이스에서 찾아옴
	...
	public String deleteQna(@ModelAttribute("user") User user, Qna qna, 
        ...
        User currentUserInfo = userService.findUserByUsername(principal.getName());
